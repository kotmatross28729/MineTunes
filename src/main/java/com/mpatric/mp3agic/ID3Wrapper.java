...
public class ID3Wrapper {
    ...
    public String getTrack() {
        if (id3v2Tag != null && id3v2Tag.getTrack() != null
            && id3v2Tag.getTrack()
                .length() > 0) {
    ...
    public String getTitle() {
        if (id3v2Tag != null && id3v2Tag.getTitle() != null
            && id3v2Tag.getTitle()
                .length() > 0) {
    ...
    public String getAlbum() {
        if (id3v2Tag != null && id3v2Tag.getAlbum() != null
            && id3v2Tag.getAlbum()
                .length() > 0) {
    ...
    public String getYear() {
        if (id3v2Tag != null && id3v2Tag.getYear() != null
            && id3v2Tag.getYear()
                .length() > 0) {
    ...
    public String getComment() {
        if (id3v2Tag != null && id3v2Tag.getComment() != null
            && id3v2Tag.getComment()
                .length() > 0) {
