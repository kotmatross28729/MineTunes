...
public final class KeyBindings {
    ...
    public static void init() {
        keyMenu = registerKey(
            new KeyBinding(LibKeys.MENU, Keyboard.KEY_HOME, LibKeys.KEY_CATEGORY),
            new HandlerMainMenu());
        keyPlayPause = registerKey(
            new KeyBinding(LibKeys.PLAY_PAUSE, Keyboard.KEY_END, LibKeys.KEY_CATEGORY),
            new HandlerPlayPause());
        keyPlus = registerKey(
            new KeyBinding(LibKeys.PLUS, Keyboard.KEY_NEXT, LibKeys.KEY_CATEGORY),
            new HandlerVolume(true));
        keyMinus = registerKey(
            new KeyBinding(LibKeys.MINUS, Keyboard.KEY_PRIOR, LibKeys.KEY_CATEGORY),
            new HandlerVolume(false));

        FMLCommonHandler.instance()
            .bus()
            .register(KeySubscriber.instance);
    }
